...
public class LeaveRequestBusinessRules {
    ...
    public void validateManagerAction(LeaveRequest leaveRequest, Long managerId) {
    ...
    public LeaveRequest getIfExist(Long id) {
        return leaveRequestRepository.findById(id)
                .orElseThrow(() -> new NotFoundException("İzin talebi bulunamadı."));
    }

    public void leaveMustBePending(LeaveRequest leaveRequest) {
